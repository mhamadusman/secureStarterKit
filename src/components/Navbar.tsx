  ...
  return (
    ...
    >
      <Toolbar
        sx={{
          display: 'flex',
          justifyContent: 'space-between', // Pushes brand/links to left, profile/GitHub to right
          alignItems: 'center',
          px: { xs: 1.5, sm: 3, md: 4 },
      ...
      >
        ...
        {/* Right Side: GitHub Star Link & Profile Dropdown */}
        <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1, sm: 1.5 } }}>
          {/* GitHub Star Link Button */}
          <Button
            component="a"
            href="https://github.com/mhamadusman/oAuth2.0-Kit" 
            target="_blank"
            rel="noopener noreferrer"
            disableRipple
            startIcon={<Star sx={{ fontSize: { xs: '1.1rem', md: '1.2rem' }, color: '#FFD700' }} />}
            sx={{
